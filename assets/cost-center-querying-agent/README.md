# Cost Center Querying Agent

An AI agent that enables Finance Controllers to query SAP S/4HANA cost center data in natural language, delivering instant answers on cost center counts and top cost centers.
