...
def main(host: str, port: int):
    skill = AgentSkill(
        id="polite-general-purpose-agent",
        name="polite-general-purpose-agent",
        description="A very polite general-purpose AI assistant that starts every response with 'Dear user, I am sorry, but ...'",
        tags=["polite", "general", "purpose", "agent"],
        examples=["What is the capital of France?", "Help me write a summary of my day."],
    )
